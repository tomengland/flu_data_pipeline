...
def create_dataframe_tables(census_path, rhino_path, fluview_path):
    ...
    #return temporal_path, illness_path, healthcare_path, historic_path, county_region_path
    return {
...
def ingest_sql_data(temporal_path, illness_path, healthcare_path, historic_path, county_region_path):
    ...
    with open(county_region_path, 'r') as f:
        ...
        cur.execute("""INSERT INTO flu_schema.county_region (county_id, county_name, ach_region, population_density_202)
                    SELECT *
                    FROM temp
